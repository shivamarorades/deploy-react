...
let Privacy_policy=()=>{
	...
	$('document').ready(function(){
			...
			document.getElementById("button2").innerHTML="Thank You we are working to improve your experience";	
			})
		})
	return(
		
	<>
	<div className="row para-center ml-3 mr-3 ">
	<div className="container ">

<h1  style={{textAlign: "center"}}><b>PRIVACY POLICY</b></h1>
<p className="mt-5">Effective date: 2020-12-18</p>
<h3>1. <b>Introduction</b></h3>
<h3>Welcome to <b> sai clinic</b>.</h3>
<p><b>sai clinic</b> (“us”, “we”, or “our”) operates <b>https://www.saiclinik.com</b> (hereinafter referred to as <b>“Service”</b>).</p>
<p>Our Privacy Policy governs your visit to <b>https://www.saiclinik.com</b>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
...
<hr/>
<h3>2. <b>Definitions</b></h3>
<p><b>SERVICE</b> means the https://www.saiclinik.com website operated by sai clinic.</p>
...
<hr/>
<h3>3. <b>Information Collection and Use</b></h3>
<p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>
<hr/>
<h3>4. <b>Types of Data Collected</b></h3>
...
<p>sai clinic uses the collected data for various purposes:</p>
...
<p>sai clinic will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
<hr/>
<h3>8. <b>Disclosure of Data</b></h3>
...
<hr/>
<h3>9. <b>Security of Data</b></h3>
<p>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>
<hr/>
<h3>10. <b>Your Data Protection Rights Under General Data Protection Regulation (GDPR)
</b></h3>
<p>If you are a resident of the European Union (EU) and European Economic Area (EEA), you have certain data protection rights, covered by GDPR.</p>
<p>We aim to take reasonable steps to allow you to correct, amend, delete, or limit the use of your Personal Data.</p>
<p> If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <b>arora1897@gmail.com</b>.</p>
...
<hr/>
<h3>11. <b>Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</b></h3>
...
<p>0.4. users are able to change their personal information by emailing us at <b>arora1897@gmail.com</b>.</p>
<p>Our Policy on “Do Not Track” Signals:</p>
<p>We honor Do Not Track signals and do not track, plant cookies, or use advertising when a Do Not Track browser mechanism is in place. Do Not Track is a preference you can set in your web browser to inform websites that you do not want to be tracked.</p>
<p>You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.</p>
<hr/>
<h3>12. <b>Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</b></h3>
...
<p>To exercise your California data protection rights described above, please send your request(s) by email: <b>arora1897@gmail.com</b>.</p>
<p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>
<hr/>
<h3>13. <b>Service Providers</b></h3>
...
<hr/>
<h3>14. <b>Analytics</b></h3>
<p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>
<hr/>
<hr/>
<h3>15. <b>CI/CD tools</b></h3>
<p>We may use third-party Service Providers to automate the development process of our Service.</p>
<hr/>
<h3>16. <b>Behavioral Remarketing</b></h3>
<p>We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.</p>
<hr/>
<h3>17. <b>Links to Other Sites</b></h3>
...
<hr/>
<h3>18. <b><b>Children’s Privacy</b></b></h3>
...
<hr/>
<h3>19. <b>Changes to This Privacy Policy</b></h3>
<p>We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.</p>
<p>We will let you know via email and/or a prominent notice on our Service, prior to the change becoming effective and update “effective date” at the top of this Privacy Policy.</p>
<p>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
<hr/>
<h3>20. <b>Contact Us</b></h3>
<p>If you have any questions about this Privacy Policy, please contact us by email: <b>arora1897@gmail.com</b>.</p>

<hr className="mt-3"></hr>
<button type="button"  className="mt-3 pt-2 pb-2 mb-3   text-white pr-5 pl-5  "id="button2"
style={{border:"none",outline:"none",backgroundColor:"#108DDC"}}
   data-bs-dismiss="alert" >Accept</button>
</div>
</div>

<footer className="para-center text-white "style={{backgroundColor:"black"}}>
<p className="pb-3 pt-3 ml-1 mr-1"style={{marginTop: "2em",textAlign:"center", fontSize: "1em"}}>
This <a href="https://policymaker.io/privacy-policy/"className="text-white">Privacy Policy</a> was created for <b>https://www.saiclinik.com</b> by <a href="https://policymaker.io"className="text-white">PolicyMaker.io</a> on 2020-12-18.</p>
</footer>
</>
);
}

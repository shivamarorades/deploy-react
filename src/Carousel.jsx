...
<div className="jumbotron  text-light trans  cover blur content cover2">
   ...
   <div className="container ">
      ...
      <p><a className="btn btn-info btn-lg" href="https://www.justdial.com/Delhi/Dr-R-K-Garg-Sai-Skin-Centre-Vikaspuri/011PXX11-XX11-130128112726-B3J6_BZDET" role="button">Learn more »</a></p>
    </div>
  </div>
